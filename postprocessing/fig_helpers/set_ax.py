def set_ax(ax, feature, tkey, tval):
    ...
    if feature == 'dual_norm':
        ...
        ax.set(xlabel=r'$'+tkey[0]+'$', ylabel=r'$\|\langle \bf{u} - \bf{\tilde{u}} \rangle\|_{H^1_0}$', xticks=tval[0], title='Absolute error in the predicted mean flow at '+r'$\mathcal{P}_{train}$')
        ...
        ax.set(xlabel=r'$'+tkey[0]+'$', ylabel=r'$\|\langle \bf{u} - \bf{\tilde{u}} \rangle\|_{L^2}$', xticks=tval[0], title='Absolute error in the predicted mean flow at '+r'$\mathcal{P}_{train}$')
