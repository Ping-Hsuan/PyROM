def vel_dual_norm_wparam(model, N, T0, mode, idx, aval, tkey, tval, fd=None):
    import numpy as np
    ...
    set_ax(ax, 'vel_dual_norm', tkey, tval)
    ...
    header = tkey[0]+','+'vel_dual_norm'
    mysave(fig, target_dir, data, 'dual_norm', header, N, fd)

if __name__ == '__main__':
    import sys
    vel_dual_norm_wparam(*sys.argv[1:])
