...
ax.legend(loc=0)
print("---------------------------------------------")
fig.savefig('.'+target_dir+'fom_h1norm.png')
np.savetxt('.'+target_dir+'angle.dat', data[:, 0])
np.savetxt('.'+target_dir+'fom_h10norm.dat', data[:, 7])
np.savetxt('.'+target_dir+'fom_l2norm.dat', data[:, 8])
np.savetxt('.'+target_dir+'fom_h1norm.dat', data[:, 9])
print("---------------------------------------------")
plt.close(fig)
...
ax.legend(loc=0)
print("---------------------------------------------")
fig.savefig('.'+target_dir+'fom_u_norm.png')
np.savetxt('.'+target_dir+'angle.dat', data[:, 0])
np.savetxt('.'+target_dir+'fom_u_h10norm.dat', data[:, 1])
np.savetxt('.'+target_dir+'fom_u_l2norm.dat', data[:, 2])
np.savetxt('.'+target_dir+'fom_u_h1norm.dat', data[:, 3])
print("---------------------------------------------")
...
ax.legend(loc=0)
print("---------------------------------------------")
fig.savefig('.'+target_dir+'fom_T_h1norm.png')
np.savetxt('.'+target_dir+'angle.dat', data[:, 0])
np.savetxt('.'+target_dir+'fom_T_h10norm.dat', data[:, 4])
np.savetxt('.'+target_dir+'fom_T_l2norm.dat', data[:, 5])
np.savetxt('.'+target_dir+'fom_T_h1norm.dat', data[:, 6])
print("---------------------------------------------")
